...
seq2seq = Seq2Seq(
    vocab_size=tokenizer._vocab_size, # 编码层和解码层公用embedding，词表相同
    hidden_size=config.hidden_size,
    num_hidden_layers=None,
    enc_num_hidden_layers=config.enc_n_layer, # 编码器和解码器可能层数不相等
    dec_num_hidden_layers=config.dec_n_layer,
    ...
    name='seq2seq'  # 模型取名，用于区分编码器和解码器
)
seq2seq.build()
seq2seq_encoder = seq2seq.encoder
seq2seq_decoder = seq2seq.decoder
...
seq2seq_output = CrossEntropy([1])([seq2seq_decoder.inputs[1], seq2seq.outputs])
seq2seq_model = keras.models.Model(seq2seq.inputs, seq2seq_output)
