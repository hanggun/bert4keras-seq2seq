...
#     featurizer = TFSpeechFeaturizer({"preemphasis": 0.97})
#     import wavio
#     wav = wavio.read('/home/zxa/ps/ASRmodel/data/data_aishell/wav/test/S0764/BAC009S0764W0495.wav').data.astype(np.float32)
#     wav = np.squeeze(wav, axis=-1)
#     print(featurizer.tf_extract(wav))