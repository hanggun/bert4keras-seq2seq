...
if __name__ == '__main__':
    text_featurizer = SubwordFeaturizer({'vocabulary': '/home/zxa/ps/ASRmodel/data/LibriSpeech/conformer.subwords'})
    print(text_featurizer.num_classes)
    a = text_featurizer.extract('i love the world every day is not change')
    print(a)
    b = text_featurizer.iextract(tf.expand_dims(a, 0))
    print(b)